<section class="page-section">
    <div class="container">
        ...
        <div class="text-center">
            <h2 class="section-heading text-uppercase">Buat Surat Pengantar Kerja Praktek</h2>
            <h3 class="section-subheading text-muted">Untuk prodi <b>Multimedia Broadcasting</b>, isi form surat dibawah:</h3>
        </div>
        <?php foreach ($data as $key) : ?>
        <?= form_open_multipart('suratmultimedia/cetak') ?>
        <div class="text-justify pl-5 pr-5">
            <div class="row">
                <div class="col-lg-6 mt-2">
                    <label for="nomor">Nomor Surat</label>
                    <input type="text" name="nomor" id="" class="form-control" value="<?= $data[0]['nomor_surat']; ?>">
                </div>
                <div class="col-lg-6 mt-2">
