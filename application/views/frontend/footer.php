        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-12 text-lg-center" style="color:white">Copyright © Sistem Pengajuan Surat Kerja Praktek PENS PSDKU Lamongan <?= date('Y')?>
					</div>
                </div>
            </div>
        </footer>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    ...
                                    <a class="btn btn-primary" href="<?= base_url('home/download_pedoman_kp')?>">Download
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    ...
                                    <a class="btn btn-primary" href="<?= base_url('home/download_proposal_kp')?>">Download
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    ...
                                    <a class="btn btn-primary" href="<?= base_url('home/download_perusahaan_kp')?>">Download
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    ...
                                    <a class="btn btn-primary" href="<?= base_url('home/download_monitoring_mahasiswa')?>">Download
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    ...
                                    <a class="btn btn-primary" href="<?= base_url('home/download_monitoring_dosen')?>">Download
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Struktur pembimbing -->
        <div class="portfolio-modal modal fade" id="pembimbing" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="close-modal" data-dismiss="modal"><img src="<?= base_url()?>assets/img/close-icon.svg" alt="Close modal" /></div>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <img class="img-fluid d-block mx-auto" src="<?= base_url('/assets/galery/'); echo $profil[0]['pembimbing']?>" alt="struktur-pembimbing" />
                                    <!-- <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                                    <ul class="list-inline">
                                        <li>Date: January 2020</li>
                                        <li>Client: Threads</li>
                                    ...
                                    <a class="btn btn-primary" href="<?= base_url('home/download_monitoring_pembimbing')?>">Download
                                    </a>
                                </div>
                            </div>
                        </div>
