 ...
 <header class="masthead" id="profil">
 	<div class="container">
 		...
 		<a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="<?= base_url('suratonline')?>">Buat Pengajuan</a>
 	</div>
 </header>
 ...
 <section class="page-section" id="struktur">
 	<div class="container">
 		...
 		<div class="row text-justify pl-5 pr-5">
 			...
 			<img class="img-fluid" src="<?= base_url('/assets/img/cara_kerja.png'); ?>">
 		</div>
 	</div>
 </section>
 ...
 <section class="page-section bg-light" id="struktur">
 	<div class="container">
 		...
 		<div class="row">
 			<div class="col-lg-4 col-sm-6 mb-4"> 
 				<div class="portfolio-item">
 					...
 					<div class="portfolio-caption">
 						<div class="portfolio-caption-subheading text-muted"><b>Klik + Download File</b></div>
 					</div>
 				</div>
 			</div>
 			...
 			<div class="col-lg-4 col-sm-6 mb-4">
 				<div class="portfolio-item">
 					<a class="portfolio-link" data-toggle="modal" href="#pembimbing">
 						<div class="portfolio-hover">
 							<div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
 						</div>
 						<img class="img-fluid" src="<?= base_url('/assets/galery/'); echo $profil[0]['pembimbing'] ?>"
 							alt="struktur-pembimbing" />
 					</a>
 					<div class="portfolio-caption">
 						<div class="portfolio-caption-subheading text-muted"><b>Klik + Download File</b></div>
 					</div>
