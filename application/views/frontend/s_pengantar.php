<section class="page-section">
    <div class="container">
        ...
        <div class="text-center">
            <h2 class="section-heading text-uppercase">Kirim Surat Pengantar Kerja Praktek</h2>
        ...
        <div class="text-justify pl-5 pr-5">
            <div class="row">
                ...
                <div class="col-lg-6 mt-2">
                    ...
                    <select class="form-control" name="keterangan_surat" id="keterangan_surat" data-style="btn btn-primary btn-round" title="Single Select" data-size="7">
