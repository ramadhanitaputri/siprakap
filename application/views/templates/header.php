		...
		<div class="sidebar" data-active-color="orange" data-background-color="black" data-image="<?= base_url() ?>/assets/img/sidebar-1.jpg">
			...
			<div class="sidebar-wrapper">
				...
				<?php if ($this->session->userdata('level') == 'koordinator') : ?>
					<div class="user">
						...
						<div class="">
							...
							&#8195; &#8195; &#8195; &#8195; 
							<a href="<?= base_url() ?>surat/pengajuan" class="dropdown-toggle" data-toggle="dropdown">
								<i class="fa fa-bell"></i>
								<span class="label label-warning"><?= $notifikasiKoor; ?></span> 
							</a>

							<a href="<?= base_url() ?>surat/pengajuan" class="dropdown-toggle" data-toggle="dropdown">
								<i class="fa fa-envelope"></i>
								<span class="label label-warning"><?= $notifikasiSurat; ?></span> 
							</a>
				...
				<?php if ($this->session->userdata('level') == 'baak') : ?>
					<div class="user">
						...
						<div class="">
							...
							<a href="<?= base_url() ?>surat/pengajuan" class="dropdown-toggle" data-toggle="dropdown">
								<i class="fa fa-bell"></i>
								<span class="label label-warning"><?= $notifikasiBaak; ?></span> 
							</a>
				...
				<ul class="nav">
							...
							<ul class="nav">
                                ...
                                ">
									<a href="<?= base_url() ?>surat/surat_keluar">
										...
										<span class="sidebar-normal">Nomor Surat</span>
									</a>
								</li>
								...
								<li class="
                                <?php if ($sub_title == 'Surat Terima Kasih') : ?>
                                    <?= 'active'; ?>
                                <?php endif; ?>
                                ">
									<a href="<?= base_url() ?>surat/terima_kasih">
										<span class="sidebar-mini">
											<i class="material-icons">navigate_next</i></span>
										</span>
										<span class="sidebar-normal">Surat Terima Kasih</span>
									</a>
								</li>
							...
							<ul class="nav">
                                ...
                                ">
									<a href="<?= base_url() ?>galery/s_linmas">
										...
										<span class="sidebar-normal">List Perusahaan KP</span>
									</a>
								</li>
								<li class="
                                <?php if ($sub_title == 'Monitoring KP - Mahasiswa') : ?>
                                    <?= 'active'; ?>
                                <?php endif; ?>
                                ">
									<a href="<?= base_url() ?>galery/s_pemuda">
										...
										<span class="sidebar-normal">Monitoring KP - Mahasiswa</span>
									</a>
								</li>
								<li class="
                                <?php if ($sub_title == 'Monitoring KP - Dosen') : ?>
                                    <?= 'active'; ?>
                                <?php endif; ?>
                                ">
									<a href="<?= base_url() ?>galery/rt_rw">
										...
										<span class="sidebar-normal">Monitoring KP - Dosen</span>
									</a>
								</li>
								<li class="
                                <?php if ($sub_title == 'Monitoring KP - Pembimbing') : ?>
                                    <?= 'active'; ?>
                                <?php endif; ?>
                                ">
									<a href="<?= base_url() ?>galery/pembimbing">
										<span class="sidebar-mini">
											<i class="material-icons">navigate_next</i></span>
										</span>
										<span class="sidebar-normal">Monitoring KP - Pembimbing</span>
									</a>
								</li>
					...
					<li class="<?php if ($title == 'Rekapan Data') : ?>
                        <?= 'active'; ?>
						<?php endif; ?>
						">
						<a href="<?= base_url('rekapan/index') ?>">
