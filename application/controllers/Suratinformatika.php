...
class Suratinformatika extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('frontend/s_informatika', $data);
    ...
    public function cetak()
    {
        ...
        if ($nama2 == '' && $nama3 == '' && $nrp2 == '' && $nrp3 == '') {
            ...
            $document = file_get_contents("./assets/file/SURAT_IT_1.rtf");
            ...
            //mengambil dokumen surat
            $document = file_get_contents("./assets/file/SURAT_IT_2.rtf");
            ...
            //mengambil dokumen surat
            $document = file_get_contents("./assets/file/SURAT_IT_3.rtf");
