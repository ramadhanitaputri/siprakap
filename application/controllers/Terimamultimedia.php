...
class Terimamultimedia extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('frontend/t_multimedia', $data);
    ...
    public function cetak()
    {
        ...
        if ($nama2 == '' && $nama3 == '' && $nrp2 == '' && $nrp3 == '') {
            ...
            $document = file_get_contents("./assets/file/SURAT_TERIMAKASIH_MMB_1.rtf");
            ...
            //mengambil dokumen surat
            $document = file_get_contents("./assets/file/SURAT_TERIMAKASIH_MMB_2.rtf");
            ...
            //mengambil dokumen surat
            $document = file_get_contents("./assets/file/SURAT_TERIMAKASIH_MMB_3.rtf");
