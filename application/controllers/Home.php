...
class Home extends CI_Controller
{
    ...
    public function download_monitoring_mahasiswa(){              
        force_download('assets/file/monitoring-mahasiswa.pdf',NULL);
    }

    public function download_monitoring_dosen(){             
        force_download('assets/file/monitoring-dosen.pdf',NULL);
    }

    public function download_monitoring_pembimbing(){                
        force_download('assets/file/monitoring-pembimbing.pdf',NULL);
    }   
}
